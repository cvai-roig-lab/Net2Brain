...
from net2brain.architectures.netsetbase import CACHE_DIR
...
class Wavegram_Logmel128_Cnn14(nn.Module):
    def __init__(self, sample_rate=32000, window_size=1024, hop_size=320, mel_bins=128, fmin=50,
                 fmax=14000, classes_num=527):
...
class Cnn14_16k(nn.Module):
    def __init__(self, sample_rate=16_000, window_size=512, hop_size=160, mel_bins=64, fmin=50, fmax=8000,
                 classes_num=527):
...
class Cnn14_8k(nn.Module):
    def __init__(self, sample_rate=8000, window_size=256, hop_size=80, mel_bins=64, fmin=50, fmax=4000,
                 classes_num=527):
...
class Cnn14_mel32(nn.Module):
    def __init__(self, sample_rate=32000, window_size=1024, hop_size=320, mel_bins=32, fmin=50,
                 fmax=14000, classes_num=527):
...
def load_panns(model_name: str, pretrained: bool = True):
    name_mapping = {
        'PANNS_Cnn10': 'Cnn10_mAP=0.380.pth',
        'PANNS_Cnn14_16k': 'Cnn14_16k_mAP=0.438.pth',
        'PANNS_Cnn14_8k': 'Cnn14_8k_mAP=0.416.pth',
        'PANNS_Cnn14_DecisionLevelAtt': 'Cnn14_DecisionLevelAtt_mAP=0.425.pth',
        'PANNS_Cnn14_DecisionLevelMax': 'Cnn14_DecisionLevelMax_mAP=0.385.pth',
        'PANNS_Cnn14_emb128': 'Cnn14_emb128_mAP=0.412.pth',
        'PANNS_Cnn14_emb32': 'Cnn14_emb32_mAP=0.364.pth',
        'PANNS_Cnn14_emb512': 'Cnn14_emb512_mAP=0.420.pth',
        'PANNS_Cnn14': 'Cnn14_mAP=0.431.pth',
        'PANNS_Cnn6': 'Cnn6_mAP=0.343.pth',
        'PANNS_DaiNet19': 'DaiNet19_mAP=0.295.pth',
        'PANNS_LeeNet11': 'LeeNet11_mAP=0.266.pth',
        'PANNS_LeeNet24': 'LeeNet24_mAP=0.336.pth',
        'PANNS_MobileNetV1': 'MobileNetV1_mAP=0.389.pth',
        'PANNS_MobileNetV2': 'MobileNetV2_mAP=0.383.pth',
        'PANNS_Res1dNet31': 'Res1dNet31_mAP=0.365.pth',
        'PANNS_Res1dNet51': 'Res1dNet51_mAP=0.355.pth',
        'PANNS_ResNet22': 'ResNet22_mAP=0.430.pth',
        'PANNS_ResNet38': 'ResNet38_mAP=0.434.pth',
        'PANNS_ResNet54': 'ResNet54_mAP=0.429.pth',
        'PANNS_Wavegram_Cnn14': 'Wavegram_Cnn14_mAP=0.389.pth',
        'PANNS_Wavegram_Logmel_Cnn14': 'Wavegram_Logmel_Cnn14_mAP=0.439.pth'
    }

    url_mapping = {
        'PANNS_Cnn10': 'https://www.dropbox.com/scl/fi/qa0yxerr2hgolamgfit20/Cnn10_mAP-0.380.pth?rlkey=s4lxw8ruul5a1b7qlb3koct8j&st=vg0ltgkk&dl=1',
        'PANNS_Cnn14_16k': 'https://www.dropbox.com/scl/fi/mvagf0dp5vx0azz3hhh73/Cnn14_16k_mAP-0.438.pth?rlkey=j1jpoix72z6igkmxlkhk5xdzx&st=s12rnk8s&dl=1',
        'PANNS_Cnn14_8k': 'https://www.dropbox.com/scl/fi/vrl3qkpmt1htlpi6yb4cr/Cnn14_8k_mAP-0.416.pth?rlkey=7d5o24bouxhc7gvzpdxyfb7k3&st=1dpfe48w&dl=1',
        'PANNS_Cnn14_DecisionLevelAtt': 'https://www.dropbox.com/scl/fi/y7u0s89zux7rhhns045nd/Cnn14_DecisionLevelAtt_mAP-0.425.pth?rlkey=xbukb21somgj28m4idfxxk906&st=2qnfhl52&dl=1',
        'PANNS_Cnn14_DecisionLevelMax': 'https://www.dropbox.com/scl/fi/lo0kp5ehku64rvox6g6tx/Cnn14_DecisionLevelMax_mAP-0.385.pth?rlkey=14uhq4x1pg05ibg9brgszb8om&st=m39cdmlg&dl=1',
        'PANNS_Cnn14_emb128': 'https://www.dropbox.com/scl/fi/9fv7n3txr7ldm4op0x3zw/Cnn14_emb128_mAP-0.412.pth?rlkey=c6p0gyj1cpb82atqdwz7ugw2b&st=8dq3c5w6&dl=1',
        'PANNS_Cnn14_emb32': 'https://www.dropbox.com/scl/fi/l3hi3a4e8jqbwz6jn39u8/Cnn14_emb32_mAP-0.364.pth?rlkey=l47uhcjxyplxizrgfue8g53v6&st=e78rlxn7&dl=1',
        'PANNS_Cnn14_emb512': 'https://www.dropbox.com/scl/fi/ihcq9c2g8wfed3cc7zy4m/Cnn14_emb512_mAP-0.420.pth?rlkey=3rj5rshlkgnsud65qxd7v305r&st=hyqlumbj&dl=1',
        'PANNS_Cnn14': 'https://www.dropbox.com/scl/fi/rx46d2hnueen32rp16bwv/Cnn14_mAP-0.431.pth?rlkey=ulafamnwewftbndm60uorvqqb&st=qkwhpz9f&dl=1',
        'PANNS_Cnn6': 'https://www.dropbox.com/scl/fi/im0m90j0w6flmat4a6sbi/Cnn6_mAP-0.343.pth?rlkey=3xzbb95bpfnvvv7lwskuozy4l&st=zi5zygoo&dl=1',
        'PANNS_DaiNet19': 'https://www.dropbox.com/scl/fi/wdq4cx4aa2mh0yqu1s0ce/DaiNet19_mAP-0.295.pth?rlkey=6zpj0qyy75kwhnsbjtig2rdrt&st=ezbwxftw&dl=1',
        'PANNS_LeeNet11': 'https://www.dropbox.com/scl/fi/8m3dan7qayt9pqr7eqfyh/LeeNet11_mAP-0.266.pth?rlkey=2q28ku2juq5j756iqzs2vlos5&st=gv7y3z4d&dl=1',
        'PANNS_LeeNet24': 'https://www.dropbox.com/scl/fi/fetnvwui54cjpgu2uwend/LeeNet24_mAP-0.336.pth?rlkey=z1yvwavp8cyj6p0m2yvtghoap&st=87o3p6me&dl=1',
        'PANNS_MobileNetV1': 'https://www.dropbox.com/scl/fi/e187vux3jj7706aifv3oi/MobileNetV1_mAP-0.389.pth?rlkey=rf8rggyvzbk6a29rdnioydyif&st=66rgxa16&dl=1',
        'PANNS_MobileNetV2': 'https://www.dropbox.com/scl/fi/orjb77i23yn0ocoymawqd/MobileNetV2_mAP-0.383.pth?rlkey=wbh10tzjhovzpxs42s33jnqwx&st=3iu57ii8&dl=1',
        'PANNS_Res1dNet31': 'https://www.dropbox.com/scl/fi/i8uck0b7w4teubfrnde26/Res1dNet31_mAP-0.365.pth?rlkey=f9o3hu8cigz4ptlsq8maz2o11&st=yw9t2ybs&dl=1',
        'PANNS_Res1dNet51': 'https://www.dropbox.com/scl/fi/rhpltquohf6rxedbyg159/Res1dNet51_mAP-0.355.pth?rlkey=0ow0mi2heoh7qo2pym95py7rn&st=mne3qzkx&dl=1',
        'PANNS_ResNet22': 'https://www.dropbox.com/scl/fi/lhqo67ai3rnhx4juv8al6/ResNet22_mAP-0.430.pth?rlkey=xykawsj3zdmx6bn2b0at6o1ms&st=jlp563rj&dl=1',
        'PANNS_ResNet38': 'https://www.dropbox.com/scl/fi/2k6mk3rtm9tkagb1fyhga/ResNet38_mAP-0.434.pth?rlkey=d75gxhocvo099hoow5dlb2bhz&st=muxj0z10&dl=1',
        'PANNS_ResNet54': 'https://www.dropbox.com/scl/fi/wesgbgzso9edykbos20q1/ResNet54_mAP-0.429.pth?rlkey=pi8xr62umf8atmz73a1ny5hj8&st=xtw283m0&dl=1',
        'PANNS_Wavegram_Cnn14': 'https://www.dropbox.com/scl/fi/ql7jiprx7nw1190360hb7/Wavegram_Cnn14_mAP-0.389.pth?rlkey=1yuj9qr6aklcvj8u1dt0vsjg1&st=dnzfsrza&dl=1',
        'PANNS_Wavegram_Logmel_Cnn14': 'https://www.dropbox.com/scl/fi/2vxrs21dknegzwsmeqsx0/Wavegram_Logmel_Cnn14_mAP-0.439.pth?rlkey=hc07z37ahbx8syvn7ok7iei1v&st=nbwk2r3j&dl=1'
    }

    "https://www.dropbox.com/scl/fi/im0m90j0w6flmat4a6sbi/Cnn6_mAP-0.343.pth?rlkey=3xzbb95bpfnvvv7lwskuozy4l&st=mfgpjyvz&dl=1"

    if not model_name in name_mapping.keys():
        raise ValueError(f"Model {model_name} not found. Use one of {list(name_mapping.keys())}")

    model = globals()[model_name[len('PANNS_'):]]()

    if pretrained:
        url = url_mapping[model_name]
        filename = CACHE_DIR / name_mapping[model_name]
