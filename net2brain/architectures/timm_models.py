...
MODELS = {
    "adv_inception_v3": timm.create_model,
...
def create_transform(model: nn.Module) -> T.Compose:
    """
...
def create_preprocess(model: nn.Module) -> Callable:
    """
    ...
    def preprocess(
        image: Union[str, Path], model_name: str, device: str
    ) -> torch.Tensor:
